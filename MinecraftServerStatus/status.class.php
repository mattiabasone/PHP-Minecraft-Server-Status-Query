 ...
 * @author Mattia Basone <mattia.basone@gmail.com> https://github.com/mattiabasone
 * @license Free to use but dont remove the author, license and copyright
 * @copyright © 2013-2015 Julian Spravil
 * @version 2.0
 * @link https://github.com/mattiabasone/PHP-Minecraft-Server-Status-Query
 *
 */
class MinecraftServerStatus {
    ...
    public function getStatus($host = '127.0.0.1', $port = 25565, $version = '1.7.*') {
        ...
        if(preg_match('/1.7|1.8/',$version)) {
            ...
            // Packet length reduced to 1 (animated MoTD support)
            if($packetlength < 1) {
                return false;
            }
     ...
     * @param $host
     * @param $port
     * @return bool|resource returns false on failure or socket on success
     */
    private function connect($host, $port) {
        ...
        while (!@socket_connect($socket, $host, $port)) {
            ...
            // if timeout reaches, return false
